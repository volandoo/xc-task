...
import { LatLng, Result, Task, TrackPoint, Waypoint } from "./types";
import fs from "fs";

export { LatLng, parseXctsk, processTask, Result, Task, TrackPoint, getTracksStats, ScoreResult, Waypoint, XCTask };
